...
POSTS_TO_FETCH     = 10
COMMENTS_PER_POST  = 30          # max comments to analyse per post
...
def fetch_posts():
    ...
    # Log in using stored session if available (avoids rate limits)
    ...
    if ig_user and ig_pass:
        try:
            ...
            print(f"⚠️  Login failed, continuing anonymously: {e}")
